...
Na poni¿szej liœcie zawarto wymagania funkcjonalne aplikacji:
\begin{enumerate}
  ...
  \item Aktywnoœci:
        \begin{enumerate}
          \item Dodawanie nowych aktywnoœci: import lub rejestrator GPS.
...
Na poni¿szej liœcie zawarto wymagania niefunkcjonalne aplikacji:
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=\linewidth]{rys02/uzycia}
