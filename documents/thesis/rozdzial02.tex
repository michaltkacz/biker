...
W wyniku zebrania wymagañ projektowych powsta³a lista ogólna lista wymagañ u¿ytkowych, któr¹ podzielono na dwie kategorie: podstawowe oraz dodatkowe. Spe³nienie wymagañ z kategorii podstawowych bêdzie równoznaczne z osi¹gniêciem wyznaczonego celu pracy. Kategoria wymagañ dodatkowych nie jest przewidziana do realizacji w ramach niniejszej pracy. Przedstawia ona jedynie pomys³y i kierunek dalszego rozwoju. Kompletna lista jest nastêpuj¹ca:
\begin{enumerate}
...
W poni¿szej liœcie zawarto wymagania funkcjonalne aplikacji:
\begin{enumerate}
        ...
        \begin{enumerate}
          ...
          \item Edycja aktywnoœci:
                \begin{itemize}
                  ...
                  \item kszta³t aktywnoœci --- pêtla lub od punktu do punktu, punkt pocz¹tkowy, punkt koñcowy;
                  \item ocena;
                  \item tagi.
                \end{itemize}
        ...
        \begin{enumerate}
          ...
          \item Wyœwietlanie statystyk profilu:
                \begin{itemize}
                  ...
                  \item ca³kowity czas aktywnoœci --- czas ca³kowity aktywnoœci;
                  \item œredni czas trwania aktywnoœci --- czas ca³kowity aktywnoœci;
                  \item najkrótsza aktywnoœæ --- czas ca³kowity aktywnoœci;
                  \item najd³u¿sza aktywnoœæ --- czas ca³kowity aktywnoœci;
                  \item œrednia prêdkoœæ --- czas ca³kowity aktywnoœci;
                  \item ca³kowity czas aktywnoœci --- czas aktywnoœci w ruchu;
                  \item œredni czas trwania aktywnoœci --- czas aktywnoœci w ruchu;
                  \item najkrótsza aktywnoœæ --- czas aktywnoœci w ruchu;
                  \item najd³u¿sza aktywnoœæ --- czas aktywnoœci w ruchu;
                  \item œrednia prêdkoœæ --- czas aktywnoœci w ruchu;
                  \item ca³kowity dystans;
                  \item œredni dystans;
                  \item najkrótszy dystans;
                  \item najd³u¿szy dystans;
                  \item ca³kowite przewy¿szenia w górê;
                  \item ca³kowite przewy¿szenia w dó³;
                  \item najni¿sze zarejestrowane po³o¿enie nad poziomem morza;
                  \item najwy¿sze zarejestrowane po³o¿enie nad poziomem morza.
                \end{itemize}
