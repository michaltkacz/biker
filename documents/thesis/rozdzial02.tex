...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\linewidth]{rys02/uzycia}
...
Porównanie koncepcji oraz dobór technologii realizacji poszczególnych modu³ów systemu zestawiono w tabeli~\ref{tab:koncepcje}. Na rysunku~\ref{fig:architektura} przedstawiono schemat ostatecznej wersji architektury systemu. Szczegó³y opisano w kolejnych podrozdzia³ach.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{rys02/architektura}
...
\begin{table}[htb] \small
  ...
  \begin{tabularx}{\linewidth}{|l|X|X|} \hline
    ...
    \texttt{useTimeout}, \texttt{useInterval} & Hooki reactowe umo¿liwiaj¹ce deklaratywne u¿ycie javscriptowych funkcji \texttt{setTimeout} oraz \texttt{setInterval} & \url{gist.github.com/Danziger/336e75b6675223ad805a88c2} \url{dfdcfd4a} \\      \hline
  \end{tabularx}
\end{table}