...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\linewidth]{rys03/fireconsole.png}
...
\begin{figure}[htb]
  ...
  \end{tabular}
  \caption{Ikony aplikacji: a) \texttt{logo.svg}, b) \texttt{logo\_maskable.svg}}
  \label{fig:pwaicons}
\end{figure}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=0.80\linewidth]{rys03/authpagetemplatedesktop}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=0.80\linewidth]{rys03/authpagedesktop}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=0.8\linewidth]{rys03/globaltemplatepage}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=0.8\linewidth]{rys03/globalpage}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.65\linewidth]{rys03/updatetrack}
...
Kroki: parsowanie, mapowanie, obliczenie statystyk i zapis do bazy pokazano na listingu~\ref{lst:import}. Listing przedstawia kod \emph{hooka} \texttt{useEffect} komponentu \texttt{GpxToActivityParser}. Widok aplikacji z interfejsem importu pokazano na rysunku~\ref{fig:globalpage}.
...
\begin{figure}[hb]
  ...
  \begin{tabular}{@{}ll@{}}
    a)                                                                              & b) \\
    \vtop{\vskip-2ex\hbox{{\includegraphics[width=0.25\textwidth]{rys03/import2}}}} &
    \vtop{\vskip-2ex\hbox{{\includegraphics[width=0.25\textwidth]{rys03/eksport2}}}}
  \end{tabular}
...
{\belowcaptionskip=-9pt
\begin{lstlisting}[language=JavaScript, style=JavaScriptStyle, label=lst:datachartmap, caption=Fragment funkcji generowania serii danych dla wykresów aktywnoœci, basicstyle=\footnotesize\ttfamily]
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{rys03/profileview}
