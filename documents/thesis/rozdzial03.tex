...
{\belowcaptionskip=-9pt
\begin{lstlisting}[language=JavaScript, style=JavaScriptStyle, label=lst:activityfunctions, caption={Kod funkcji: edycji, usuniêcia oraz eksportu aktywnoœci}, basicstyle=\footnotesize\ttfamily]
...
{\belowcaptionskip=-9pt
\begin{lstlisting}[language=JavaScript, style=JavaScriptStyle, label=lst:datachartmap, caption=Fragment kodu funkcji generowania serii danch dla wykresów aktywnoœci, basicstyle=\footnotesize\ttfamily]
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.98\linewidth]{rys03/activitydatastats}
  \caption{Widok danych i statystyk aktywnoœci}
  \label{fig:activitydatastats}
\end{figure}

\begin{figure}[hb]
  \centering
  \includegraphics[width=0.98\linewidth]{rys03/activitycharts2}
